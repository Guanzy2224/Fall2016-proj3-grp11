...
save_Rdata_Name="feature_training.Rdata" #You can also specify the address to store the .Rdata file
...
# save(SomepredictorX,responseY,testX,file=save_Rdata_Name)
  save(SomepredictorX,responseY,rf,scaleSD,featuresMean,file=save_Rdata_Name) # save rf for easy check, not for using
